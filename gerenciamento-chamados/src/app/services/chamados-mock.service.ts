...
import { Chamado, StatusChamado } from '../chamados/models/chamado.model';

type ChamadoCreate = Omit<Chamado, 'id' | 'createdAt'>;

@Injectable({ providedIn: 'root' })
export class ChamadosMockService {
  private _chamados = signal<Chamado[]>([
    {
      id: 1,
      titulo: 'Chamado 1',
  ...
  public byStatus(status: StatusChamado): Chamado[] {
  ...
  public update(id: number, patch: Partial<Chamado>) {
    this._chamados.update(arr =>
